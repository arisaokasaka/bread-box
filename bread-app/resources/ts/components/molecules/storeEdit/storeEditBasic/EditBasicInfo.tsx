            ...
            <div className = "m-storeEdit-basic__container" key = {StoreInfo.uuid}>
                ...
                <form className="m-storeEdit-basic__container__form m-storeForm" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="m-storeEdit-basic__container__form__item m-storeForm__item">
                        ...
                        <div className="m-storeEdit-basic__container__form__item__input m-storeForm__item__input">
                            <input type="text" name="address" id="store_address" defaultValue={StoreInfo.address} onChange={e => setInfo({...info, address: e.target.value})} ref={register({required: true})}/>
                    ...
                    <div className="m-storeEdit-basic__container__form__item m-storeForm__item">
                        ...
                        <div className="m-storeEdit-basic__container__form__item__input m-storeForm__item__input">
                            <input type="email" name="email" id="store_email" defaultValue={StoreInfo.email} onChange={e => setInfo({...info, email: e.target.value})} ref={register({required: true})}/>
                    ...
                    <div className="m-storeEdit-basic__container__form__item m-storeForm__item">
                        ...
                        <div className="m-storeEdit-basic__container__form__item__input m-storeForm__item__input">
                            ...
                            <input type="tel" name="tel" id="store_tel" defaultValue={StoreInfo.tel} onChange={e => setInfo({...info, tel: e.target.value})} ref={register({pattern: /[0-9]/, maxLength: 11, minLength:10})}/>
